  ...
  <body>
    ...
    >
      ...
      <g class="whole">
        ...
        <text x="410" y="350" font-family="Comic Sans MS, Brush Script MT, cursive" font-size="40" fill="#F6B8BB" text-anchor="middle" font-weight="bold">瑶瑶宝贝</text>
        <text x="410" y="400" font-family="Comic Sans MS, Brush Script MT, cursive" font-size="32" fill="#FFD6D7" text-anchor="middle">圣诞喜乐</text>
        <text x="410" y="450" font-family="Comic Sans MS, Brush Script MT, cursive" font-size="32" fill="#D99898" text-anchor="middle">岁岁常安</text>
</g>
      </g>
    </svg>
  </body>
